...
public class CommandLineArgs {
  ...
  public CommandLineArgs(Integer port, boolean accessLoggingEnabled) {
    this.port = port;
  ...
  public static CommandLineArgs fromArgs(String[] args) {
    ...
    logger.info("Command line args: port={}", port);
    return new CommandLineArgs(port, enableAccessLogging);
  }
}
