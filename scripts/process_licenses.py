...
ADDITIONAL_LICENSES_MAP = {
    ...
    "io.netty:netty-codec-http": APACHE_LICENSE,
    "io.netty:netty-codec-http2": APACHE_LICENSE,
    "io.netty:netty-codec-socks": APACHE_LICENSE,
    ...
    "io.grpc:grpc-netty": APACHE_LICENSE,
