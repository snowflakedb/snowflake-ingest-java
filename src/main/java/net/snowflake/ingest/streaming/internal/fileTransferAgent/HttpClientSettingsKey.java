 ...
 * through to storage client upload methods.
 */
...
public class HttpClientSettingsKey implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (other.ocspMode.getValue() != this.ocspMode.getValue()) {
      return false;
    }
    if (!other.useProxy && !this.useProxy) {
      return true;
    }
  ...
  public int hashCode() {
    return this.ocspMode.getValue()
        + (this.proxyHost + this.proxyPort + this.proxyUser + this.proxyPassword
            + this.proxyProtocol).hashCode();
  }
}
