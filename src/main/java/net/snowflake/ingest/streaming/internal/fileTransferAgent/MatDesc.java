 ...
 * Source: https://github.com/snowflakedb/snowflake-jdbc/blob/v3.25.1/src/main/java/net/snowflake/client/jdbc/MatDesc.java
 *
 * Permitted differences: package, ObjectMapperFactory uses ingest version.
 */
