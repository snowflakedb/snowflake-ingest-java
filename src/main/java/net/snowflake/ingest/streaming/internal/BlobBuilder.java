    ...
    for (List<ChannelData<T>> channelsDataPerTable : blobData) {
      ...
      if (!result.channelsMetadataList.isEmpty()) {
        ...
        byte[] encryptedCompressedChunkData =
            Cryptor.encrypt(
                compressedAndPaddedChunkData, firstChannelContext.encryptionKey, filePath, iv);
        ...
        ChunkMetadata chunkMetadata =
            ChunkMetadata.builder()
                .setOwningTableFromChannelContext(firstChannelContext)
                ...
                .setChunkMD5(md5)
                .setEncryptionKeyId(firstChannelContext.encryptionKeyId)
                .setEpInfo(
        ...
        logger.logInfo(
            "Finish building chunk in blob={}, table={}, rowCount={}, startOffset={},"
                ...
                + " bdecVersion={}",
            filePath,
            firstChannelContext.fullyQualifiedTableName,
            result.rowCount,
            startOffset,
            chunkData.size(),
