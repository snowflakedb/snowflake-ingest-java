 ...
 * Source: https://github.com/snowflakedb/snowflake-jdbc/blob/v3.25.1/src/main/java/net/snowflake/client/core/EventHandler.java
 */
...
public class EventHandler extends Handler {
  ...
  private static final int THROTTLE_DURATION_HRS =
      LogUtil.systemGetProperty(THROTTLE_DURATION_PROP) == null
          ? 1
          : Integer.valueOf(LogUtil.systemGetProperty(THROTTLE_DURATION_PROP));

  private static final int INCIDENT_THROTTLE_LIMIT_PER_HR =
      LogUtil.systemGetProperty(THROTTLE_LIMIT_PROP) == null
          ? 1
          : Integer.valueOf(LogUtil.systemGetProperty(THROTTLE_LIMIT_PROP));
  ...
  public void dumpLogBuffer(String identifier) {
    ...
    boolean disableCompression = LogUtil.systemGetProperty(DISABLE_DUMP_COMPR_PROP) != null;
  ...
  protected void cleanupSfDumps(boolean deleteOldest) {
    ...
    int maxDumpFiles =
        LogUtil.systemGetProperty(MAX_NUM_DUMP_FILES_PROP) != null
            ? Integer.valueOf(LogUtil.systemGetProperty(MAX_NUM_DUMP_FILES_PROP))
            : DEFAULT_MAX_DUMP_FILES;

    int maxDumpDirSizeMB =
        LogUtil.systemGetProperty(MAX_SIZE_DUMPS_MB_PROP) != null
            ? Integer.valueOf(LogUtil.systemGetProperty(MAX_SIZE_DUMPS_MB_PROP))
