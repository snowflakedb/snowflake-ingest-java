 ...
 * Source: https://github.com/snowflakedb/snowflake-jdbc/blob/v3.25.1/src/main/java/net/snowflake/client/jdbc/cloud/storage/GcmEncryptionProvider.java
 *
 * Permitted differences: package, MatDesc/RemoteStoreFileEncryptionMaterial/
 * StorageObjectMetadata/SnowflakeStorageClient use ingest versions (same package).
 */
