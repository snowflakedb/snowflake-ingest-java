    ...
    try {
      ParquetWriter<List<Object>> writer =
          new BdecParquetWriterBuilder(bdecOutput, schema, metadata)
              ...
              // server side does not support it yet, this may be an easy fix in future
              // TODO: SNOW-620624
              .withWriterVersion(ParquetProperties.WriterVersion.PARQUET_1_0)
              // we do not use the dictionary encoding for simplicity now to avoid issues in the
              // earlier versions
              // later this can be reconsidered
