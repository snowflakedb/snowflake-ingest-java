...
import net.snowflake.client.jdbc.internal.fasterxml.jackson.databind.module.SimpleModule;
import net.snowflake.client.jdbc.internal.fasterxml.jackson.databind.ser.std.ToStringSerializer;
