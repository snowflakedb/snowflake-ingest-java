/* Replicated from snowflake-jdbc (v3.25.1) Source: https://github.com/snowflakedb/snowflake-jdbc/blob/v3.25.1/src/main/java/net/snowflake/client/jdbc/cloud/storage/GCSDefaultAccessStrategy.java */
