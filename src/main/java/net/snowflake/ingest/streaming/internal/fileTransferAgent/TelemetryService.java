 ...
 * Source: https://github.com/snowflakedb/snowflake-jdbc/blob/v3.25.1/src/main/java/net/snowflake/client/jdbc/telemetryOOB/TelemetryService.java
 *
 * Permitted differences: package, SFLogger/SFLoggerFactory use ingest versions,
 * SecretDetector uses ingest version (fileTransferAgent.log package),
 * Stopwatch uses ingest version (utils package),
 * SnowflakeConnectString/TelemetryEvent/TelemetryThreadPool use ingest versions (same package).
      ...
      try {
        ...
        logger.debug(
            "Out-of-band telemetry request success: {} and clean the current queue. It took {} ms."
                + " Total successful events: {}, total unsuccessful events: {} (client failures:"
                + " {}, server failures: {})",
            success,
