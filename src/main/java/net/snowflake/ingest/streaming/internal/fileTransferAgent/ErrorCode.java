 ...
 *
 * Permitted differences: package, errorMessageResource path updated,
 * SqlState import uses JDBC shaded path temporarily.
 * Placed in fileTransferAgent package (not utils) because utils already has
 * its own ErrorCode enum with different values.
 */
