 ...
 * Source: https://github.com/snowflakedb/snowflake-jdbc/blob/v3.25.1/src/main/java/net/snowflake/client/core/OCSPTelemetryData.java
 *
 * Permitted differences: package declaration,
 * OCSPMode -> net.snowflake.ingest.utils.OCSPMode,
 * TelemetryService uses ingest replicated version (same package).
 */
