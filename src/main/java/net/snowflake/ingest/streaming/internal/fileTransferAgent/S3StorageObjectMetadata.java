 ...
 * Source: https://github.com/snowflakedb/snowflake-jdbc/blob/v3.25.1/src/main/java/net/snowflake/client/jdbc/cloud/storage/S3StorageObjectMetadata.java
 *
...
public class S3StorageObjectMetadata implements StorageObjectMetadata {
  ...
  public Map<String, String> getUserMetadata() {
    return StorageClientUtil.createCaseInsensitiveMap(this.s3Metadata.getUserMetadata());
  }
