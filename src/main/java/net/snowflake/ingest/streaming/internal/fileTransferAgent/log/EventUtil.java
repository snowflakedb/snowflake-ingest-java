 ...
 * Source: https://github.com/snowflakedb/snowflake-jdbc/blob/v3.25.1/src/main/java/net/snowflake/client/core/EventUtil.java
 */
...
public class EventUtil {
  ...
  private static String DUMP_PATH_PREFIX =
      LogUtil.systemGetProperty(DUMP_PATH_PROP) == null
          ? "/tmp"
          : LogUtil.systemGetProperty(DUMP_PATH_PROP);
  private static final long MAX_DUMP_FILE_SIZE_BYTES =
      LogUtil.systemGetProperty(DUMP_SIZE_PROP) == null
          ? (10 << 20)
          : Long.valueOf(LogUtil.systemGetProperty(DUMP_SIZE_PROP));
