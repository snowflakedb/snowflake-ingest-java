 ...
 * Source: https://github.com/snowflakedb/snowflake-jdbc/blob/v3.25.1/src/main/java/net/snowflake/client/log/SFLoggerFactory.java
 */
...
public class SFLoggerFactory {
  ...
  enum LoggerImpl {
    SLF4JLOGGER("net.snowflake.ingest.streaming.internal.fileTransferAgent.log.SLF4JLogger"),
    JDK14LOGGER("net.snowflake.ingest.streaming.internal.fileTransferAgent.log.JDK14Logger");
  ...
  public static SFLogger getLogger(Class<?> clazz) {
    ...
    if (loggerImplementation == null) {
      String logger = LogUtil.systemGetProperty("net.snowflake.jdbc.loggerImpl");
