 ...
 *
 * Permitted differences: package, SFLogger/ResourceBundleManager/ErrorCode use ingest versions,
 * errorResourceBundleManager path updated. SFException import kept from JDBC temporarily.
 */
