...
public class HistoryResponse {
  ...
  public static class FileEntry {
    ...
    public String toString() {
      ...
      if (errorsSeen != 0) {
        result
            ...
            .append(firstError)
            .append("\n")
            .append("FirstErrorLineNum: ")
            .append(firstErrorLineNum)
            .append("\n")
            .append("FirstErrorCharacterPos: ")
            .append(firstErrorCharacterPos)
            .append("\n")
            .append("FirstErrorColumnName: ")
            .append(firstErrorColumnName)
            .append("\n")
            .append("SystemError: ")
            .append(systemError)
     ...
     * but the load process has not completed yet. LOADED: The entire file has been loaded into the
     * table. LOAD_FAILED: The file load failed. PARTIALLY_LOADED: Some rows from this file were
     * loaded successfully, but others were not loaded due to errors. Processing of this file is
     * completed.
     */
  ...
  /**
   * beginMark to use on the next request to avoid seeing duplicate records. (Note that this value
   * is a hint. Duplicates can still occasionally occur.)
   */
