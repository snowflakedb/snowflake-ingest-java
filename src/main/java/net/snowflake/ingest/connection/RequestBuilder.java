...
public final class RequestBuilder
{
  ...
  private static final String HISTORY_RANGE_START = "startTime";

  // End time for the history range; is optional
  private static final String HISTORY_RANGE_END = "endTime";
          ...
          throws URISyntaxException
  {
    ...
    if (startTime != null)
    {
      builder.setParameter(HISTORY_RANGE_START, startTime);
    }

    if (endTime != null)
    {
      builder.setParameter(HISTORY_RANGE_END, endTime);
    }
