...
public class BdecParquetWriter implements AutoCloseable {
  ...
  public BdecParquetWriter(
    ...
    ParquetProperties encodingProps = createParquetProperties(allocator);
  ...
  private static ParquetProperties createParquetProperties(BufferAllocator allocator) {
    return ParquetProperties.builder()
        ...
        .withAllocator(new ArrowByteBufferAllocator(allocator, true))
        .build();
  }
