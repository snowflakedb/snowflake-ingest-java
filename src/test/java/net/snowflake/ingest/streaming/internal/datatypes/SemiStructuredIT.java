...
public class SemiStructuredIT extends AbstractDataTypeTest {
  ...
  public void testVariant() throws Exception {
    // Test dates
    assertVariant(
        "VARIANT", LocalTime.of(0, 0, 0, 123), "\"00:00:00.000000123\"", "VARCHAR", false);
    assertVariant(
        "VARIANT",
        ...
        "VARCHAR",
        false);
    assertVariant("VARIANT", LocalDate.of(1970, 1, 1), "\"1970-01-01\"", "VARCHAR", false);
    assertVariant(
        "VARIANT", LocalDateTime.of(1970, 1, 1, 0, 0, 0), "\"1970-01-01T00:00\"", "VARCHAR", false);
    assertVariant(
        "VARIANT",
  ...
  public void testTooLargeValues() throws Exception {
    expectArrowNotSupported("VARIANT", createLargeVariantObject(MAX_LENGTH + 1));
    expectArrowNotSupported("OBJECT", createLargeVariantObject(MAX_LENGTH + 1));
    expectArrowNotSupported("ARRAY", "[" + createLargeVariantObject(MAX_LENGTH - 1) + "]");
  }

  @Test
  @Ignore("SNOW-664249")
  public void testMaxVariantAndObject() throws Exception {
    String maxObject = createLargeVariantObject(MAX_LENGTH);
    assertVariant("VARIANT", maxObject, maxObject, "OBJECT", true);
    assertVariant("VARIANT", maxObject, maxObject, "VARIANT", true);
  }

  @Test
  @Ignore("SNOW-664249")
  public void testMaxArray() throws Exception {
    String maxArray = "[" + createLargeVariantObject(MAX_LENGTH - 2) + "]";
    assertVariant("VARIANT", maxArray, maxArray, "OBJECT", false);
  }

  public String createLargeVariantObject(int size) throws JsonProcessingException {
