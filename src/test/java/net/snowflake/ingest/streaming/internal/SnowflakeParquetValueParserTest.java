...
public class SnowflakeParquetValueParserTest {
  ...
  public void parseValueFixedSB1ToInt32() {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            12, testCol, PrimitiveType.PrimitiveTypeName.INT32, rowBufferStats, UTC, 0, ParameterProvider.ENABLE_NEW_JSON_PARSING_LOGIC_DEFAULT);
  ...
  public void parseValueFixedSB2ToInt32() {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            1234, testCol, PrimitiveType.PrimitiveTypeName.INT32, rowBufferStats, UTC, 0, ParameterProvider.ENABLE_NEW_JSON_PARSING_LOGIC_DEFAULT);
  ...
  public void parseValueFixedSB4ToInt32() {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            123456789, testCol, PrimitiveType.PrimitiveTypeName.INT32, rowBufferStats, UTC, 0, ParameterProvider.ENABLE_NEW_JSON_PARSING_LOGIC_DEFAULT);
  ...
  public void parseValueDouble() {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            12345.54321d, testCol, PrimitiveType.PrimitiveTypeName.DOUBLE, rowBufferStats, UTC, 0, ParameterProvider.ENABLE_NEW_JSON_PARSING_LOGIC_DEFAULT);
  ...
  public void parseValueBoolean() {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            true, testCol, PrimitiveType.PrimitiveTypeName.BOOLEAN, rowBufferStats, UTC, 0, ParameterProvider.ENABLE_NEW_JSON_PARSING_LOGIC_DEFAULT);
  ...
  private void testJsonWithLogicalType(String logicalType, boolean enableNewJsonParsingLogic) {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            var, testCol, PrimitiveType.PrimitiveTypeName.BINARY, rowBufferStats, UTC, 0, enableNewJsonParsingLogic);
  ...
  public void parseValueArrayToBinaryInternal(boolean enableNewJsonParsingLogic) {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            input, testCol, PrimitiveType.PrimitiveTypeName.BINARY, rowBufferStats, UTC, 0, enableNewJsonParsingLogic);
  ...
  public void parseValueTextToBinary() {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            text, testCol, PrimitiveType.PrimitiveTypeName.BINARY, rowBufferStats, UTC, 0, ParameterProvider.ENABLE_NEW_JSON_PARSING_LOGIC_DEFAULT);
  ...
  public void parseValueTimeSB4ToInt32() {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            "01:00:00", testCol, PrimitiveType.PrimitiveTypeName.INT32, rowBufferStats, UTC, 0, ParameterProvider.ENABLE_NEW_JSON_PARSING_LOGIC_DEFAULT);
  ...
  public void parseValueTimeSB8ToInt64() {
    ...
    ParquetBufferValue pv =
        SnowflakeParquetValueParser.parseColumnValueToParquet(
            "01:00:00.123", testCol, PrimitiveType.PrimitiveTypeName.INT64, rowBufferStats, UTC, 0, ParameterProvider.ENABLE_NEW_JSON_PARSING_LOGIC_DEFAULT);
