...
DOWNLOAD_URL="https://github.com/google/google-java-format/releases/download/v1.17.0/google-java-format-1.17.0-all-deps.jar"
JAR_FILE="./.cache/google-java-format-1.17.0-all-deps.jar"
